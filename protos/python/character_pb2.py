...
CharacterResponse = _reflection.GeneratedProtocolMessageType('CharacterResponse', (_message.Message,), dict(
  ...
  def add_CharactersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'Get': grpc.unary_unary_rpc_method_handler(
            servicer.Get,
            request_deserializer=CharacterRequest.FromString,
            response_serializer=CharacterResponse.SerializeToString,
        ),
    }
